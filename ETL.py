...
Airbnb_df['Price'].fillna(Airbnb_df.groupby('Neighbourhood')['Price'].transform('median'), inplace=True)
...
Airbnb_df = Airbnb_df[(Airbnb_df['Number of Records'] >= 1) & (Airbnb_df['Review Scores Rating'] <= 100)]
